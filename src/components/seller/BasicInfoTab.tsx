...
const BasicInfoTab = ({ formData, setFormData, handlePropertyTypeChange }: BasicInfoTabProps) => {
  ...
  const canSetFeatured = profile?.user_type === 'partner_and_site_owner';

  return (
    <div className="space-y-6">
      <div className="border rounded-lg p-4 mb-4">
        <h3 className="text-lg font-semibold mb-2">{t("basicPropertyInformation")}</h3>
      ...
      <div className="border rounded-lg p-4 mb-4">
        <h3 className="text-lg font-semibold mb-2">{t("pricingInformation")}</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
      ...
      <div className="border rounded-lg p-4 mb-4">
        <h3 className="text-lg font-semibold mb-2">{t("studentHousingOptions")}</h3>
